...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        String[] someSting = test.split(" ");

        Integer result = 0;

        switch (someSting[1]) {
            case ("+"):
                result = Integer.parseInt(someSting[0]) + Integer.parseInt(someSting[2]);
                break;
            case ("-"):
                result = Integer.parseInt(someSting[0]) - Integer.parseInt(someSting[2]);
                break;
        ...
        System.out.println(someSting[0] + " " + someSting[1] + " " + someSting[2] + " = " + result);
